...
public class LeftFish extends EnemyFish {
    ...
    public void initial(int arg0,float arg1,float arg2){
        ...
        speed = ran.nextInt(8) + 10 * arg0;

        object_y = ran.nextInt((int)(screen_height - object_height));
        object_x = -object_height * (currentCount * 2 + 1);
        currentCount++;
    ...
    public void initBitmap() {
        ...
        smallPlane = BitmapFactory.decodeResource(resources, R.drawable.smallfish);
